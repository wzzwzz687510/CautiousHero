...
public class IfShowAttribute : PropertyAttribute
{
    ...
    public IfShowAttribute(string conditionFieldName)
    {
    ...
    public IfShowAttribute(string conditionFieldName, object comparationValue = null)
    {
        this.conditionFieldName = conditionFieldName;
    ...
    public IfShowAttribute(string conditionFieldName, object[] comparationValueArray = null)
    {
        this.conditionFieldName = conditionFieldName;
